...
{{- /* These atomics are used by clang for CGo'ed code. */ -}}
{{template "rmw" (tuple "sub" . false "new = old - value")}}
{{template "rmw" (tuple "and" . false "new = old & value")}}
{{template "rmw" (tuple "or" . false "new = old | value")}}
{{template "rmw" (tuple "xor" . false "new = old ^ value")}}
{{template "rmw" (tuple "nand" . false "new = ^(old & value)")}}
{{- end}}
{{template "atomics" 1 -}}
{{template "atomics" 2 -}}
{{template "atomics" 4 -}}
